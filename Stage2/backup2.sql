...
prompt Created by Yoni Klein on Wednesday, June 19, 2024
set feedback off
set define off
...
alter table VEHICLE disable constraint SYS_C009452;
prompt Disabling foreign key constraints for DRIVEAT...
alter table DRIVEAT disable constraint SYS_C009457;
alter table DRIVEAT disable constraint SYS_C009458;
prompt Disabling foreign key constraints for HADACCIDENT...
alter table HADACCIDENT disable constraint SYS_C009462;
alter table HADACCIDENT disable constraint SYS_C009463;
prompt Disabling foreign key constraints for HADTRIP...
alter table HADTRIP disable constraint SYS_C009471;
alter table HADTRIP disable constraint SYS_C009472;
prompt Disabling foreign key constraints for HASTRIPS...
alter table HASTRIPS disable constraint SYS_C009476;
alter table HASTRIPS disable constraint SYS_C009477;
prompt Disabling foreign key constraints for MAINTENANCERECORD...
alter table MAINTENANCERECORD disable constraint SYS_C009482;
prompt Disabling foreign key constraints for MADEMAINTENANCE...
alter table MADEMAINTENANCE disable constraint SYS_C009486;
alter table MADEMAINTENANCE disable constraint SYS_C009487;
...
alter table VEHICLE enable constraint SYS_C009452;
prompt Enabling foreign key constraints for DRIVEAT...
alter table DRIVEAT enable constraint SYS_C009457;
alter table DRIVEAT enable constraint SYS_C009458;
prompt Enabling foreign key constraints for HADACCIDENT...
alter table HADACCIDENT enable constraint SYS_C009462;
alter table HADACCIDENT enable constraint SYS_C009463;
prompt Enabling foreign key constraints for HADTRIP...
alter table HADTRIP enable constraint SYS_C009471;
alter table HADTRIP enable constraint SYS_C009472;
prompt Enabling foreign key constraints for HASTRIPS...
alter table HASTRIPS enable constraint SYS_C009476;
alter table HASTRIPS enable constraint SYS_C009477;
prompt Enabling foreign key constraints for MAINTENANCERECORD...
alter table MAINTENANCERECORD enable constraint SYS_C009482;
prompt Enabling foreign key constraints for MADEMAINTENANCE...
alter table MADEMAINTENANCE enable constraint SYS_C009486;
alter table MADEMAINTENANCE enable constraint SYS_C009487;
